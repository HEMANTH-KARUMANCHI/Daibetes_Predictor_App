...
#  Project Overview
  ...
  This project aims to predict whether a person has diabetes using medical diagnostic measurements. We use a supervised machine learning approach and the Logistic Regression algorithm to classify individuals as diabetic or not,     based on features like glucose levels, BMI, and age etc.
...
- Can be improved with more features, using feature engineering, and also the better models.
